...
#define READ_BUFFERSIZE                                 23         //读取数据数组长度
...
#define DATA_FrameHead_1                   (unsigned char)(127)       //接收数据的帧头
#define DATA_FrameHead_2                   (unsigned char)(128)       //接收数据的帧头
