...
#ifndef SRC_TEST_IMUCOMMAND_H
#define SRC_TEST_IMUCOMMAND_H
...
#include "imu_1129/test_serial.h"
#include <sensor_msgs/Imu.h>

#define CMD_FrameHead                                  165         //指令帧头
#define READ_BUFFERSIZE                                115         //读取数据数组长度, 23 bytes * 5
#define VALID_DATASIZE                                  23         //数据数组长度, 23 bytes
...
//判断本帧数据类型
#define DATA_FrameHead_1                   (unsigned char)(127)       //接收数据的帧头, dec:127 -- Hex:7f
#define DATA_FrameHead_2                   (unsigned char)(128)       //接收数据的帧头, dec:128 -- Hex:80
...
public:
    ...
    unsigned char valid_data[VALID_DATASIZE];
...
}  // end of namespace LINESTECH


/////////////////////////////////////

#endif //SRC_TEST_IMUCOMMAND_H
